(function () {
  ...
  var withNativeBlob$1 = typeof commonjsGlobal.Blob === 'function' || toString$5.call(commonjsGlobal.Blob) === '[object BlobConstructor]';
  var withNativeFile$1 = typeof commonjsGlobal.File === 'function' || toString$5.call(commonjsGlobal.File) === '[object FileConstructor]';
  ...
  var debug$3 = browser$1('engine.io-client:polling');
  ...
  var debug$4 = browser$1('engine.io-client:polling-xhr');
  ...
  function JSONPPolling (opts) {
    ...
    if (!callbacks$1) {
      ...
      callbacks$1 = commonjsGlobal.___eio;
    }
  ...
  var debug$5 = browser$1('engine.io-client:websocket');
  ...
  var debug$6 = browser$1('engine.io-client:socket');
  ...
  */
  ...
  // - escapes [!'()*]
  // - preserve commas
  var encode$3 = function (str) { return encodeURIComponent(str)
    ...
    var res = obj ? Object.keys(obj).map(function (key) {
      ...
      if (Array.isArray(val)) {
        ...
        val.forEach(function (val2) {
          ...
          if (val2 === null) {
            result.push(encode$3(key));
          } else {
            result.push(encode$3(key) + '=' + encode$3(val2));
          }
        });
        return result.join('&')
      }

      return encode$3(key) + '=' + encode$3(val)
  ...
  var SocketEvent = {
      fire: function (event, data, options) { lib$1().emit(event, data || null); },
      on: function (event, callback) { lib$1().on(event, callback); }
  };
  ...
  var script = {
      mounted: function () {
          var _this = this;
          this.resetData();
          VueEvent.on('modal-open-new-game', function (data) {
      ...
      methods: {
          ...
          startGame: function () {
              var _this = this;
              axios$1.post('/api/games/new', this.formData).then(function (res) {
                  // update cookie and playerDate
                  _this.$parent.updatePlayerData({
                      gameId: res.data.gameId,
                      id: res.data.playerId,
                      name: _this.formData.playerName
                  });
                  _this.$router.push("/games/" + res.data.gameId);
                  _this.closePopup();
              });
          }
      }
  ...
  var __vue_render__ = function() {
    ...
    return _c("div", { class: "modal" + (_vm.modalOpen ? " is-active" : "") }, [
      ...
      _c("div", { staticClass: "modal-content box" }, [
        ...
        _c("div", { staticClass: "columns" }, [
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
              _c("label", { staticClass: "label" }, [_vm._v("Player name")]),
              _vm._v(" "),
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.playerName,
                      expression: "formData.playerName"
                    }
                  ],
                  staticClass: "input",
                  attrs: { type: "text", placeholder: "Surf_King" },
                  domProps: { value: _vm.formData.playerName },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.formData, "playerName", $event.target.value);
                    }
                  }
                })
              ]),
              ...
              _c("p", { staticClass: "help" }, [
                _vm._v(
                  "Your player name in the game, max 12 characters, numbers and letters only."
                )
              ])
            ])
          ]),
          ...
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
              _c("label", { staticClass: "label" }, [_vm._v("Game name")]),
              _vm._v(" "),
              _c("div", { staticClass: "control" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.gameName,
                      expression: "formData.gameName"
                    }
                  ],
                  staticClass: "input",
                  attrs: { type: "text", placeholder: "BattleBots_Attack" },
                  domProps: { value: _vm.formData.gameName },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.formData, "gameName", $event.target.value);
                    }
                  }
                })
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "help" }, [
                _vm._v("All games need a name right?")
              ])
            ])
          ])
        ]),
        ...
        _c("div", { staticClass: "columns" }, [
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formData.maxPlayers,
                          expression: "formData.maxPlayers"
                        }
                      ],
                      on: {
              ...
              _vm._v(" "),
              _c("p", { staticClass: "help" }, [_vm._v("Minimum 2, Maximum 4.")])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
              _c("label", { staticClass: "label" }, [_vm._v("Turn time limit")]),
              _vm._v(" "),
              _c("div", { staticClass: "control" }, [
                _c("div", { staticClass: "select is-primary" }, [
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formData.turnTimeLimit,
                          expression: "formData.turnTimeLimit"
                        }
                      ],
                      on: {
                        change: function($event) {
                    ...
                    [
                      _c("option", { attrs: { selected: "", value: "30000" } }, [
                        _vm._v("30 seconds")
                      ]),
                      _vm._v(" "),
              ...
              _c("p", { staticClass: "help" }, [
                _vm._v(
                  "Keep the game moving with a time limit on each player\\'s turn, after which they\\'ll be forced to discard and end their turn."
                )
              ])
            ])
          ])
        ...
        _c("div", { staticClass: "columns" }, [
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
              _c("label", { staticClass: "label" }, [_vm._v("Game access")]),
              _vm._v(" "),
              _c("div", { staticClass: "control" }, [
                _c("div", { staticClass: "select is-primary" }, [
                  _c(
                    ...
                    [
                      _c("option", { attrs: { selected: "", value: "public" } }, [
                        _vm._v("Public")
                      ]),
                      _vm._v(" "),
              ...
              _c("p", { staticClass: "help" }, [
                _vm._v(
                  "Anyone can join a public game. Private games require an access key to join."
                )
              ])
            ])
          ]),
          ...
          _c("div", { staticClass: "column" }, [
            _c("div", { staticClass: "field" }, [
              _c("label", { staticClass: "label" }, [_vm._v("Score limit")]),
              _vm._v(" "),
              _c("div", { staticClass: "control" }, [
                _c("div", { staticClass: "select is-primary" }, [
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formData.scoreLimit,
                          expression: "formData.scoreLimit"
                        }
                      ],
                      on: {
                        change: function($event) {
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { selected: "", value: "100" } }, [
                        _vm._v("100 points")
                      ]),
                      _vm._v(" "),
  ...
  var __vue_staticRenderFns__ = [
    function() {
      ...
      return _c("div", { staticClass: "columns" }, [
        _c("div", { staticClass: "column" }, [
          _c("h2", { staticClass: "title is-3" }, [_vm._v("Start a new game")])
        ])
      ])
    }
  ];
  ...
  function __vue_normalize__(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\components\\ModalNewGame.vue";
    }
  ...
  var ModalNewGame = __vue_normalize__(
    __vue_template__,
  ...
  var script$1 = {
      mounted: function () {
          var _this = this;
          this.resetData();
          VueEvent.on('modal-open-join-game', function (game) {
              _this.modalOpen = true;
              _this.game = game;
          });
      },
              ...
              axios$1.post('/api/game/join', {
                  ...
                  if (res.data.success) {
                      _this.$parent.updatePlayerData({
                          id: res.data.playerId,
                          name: _this.formData.playerName,
                          gameId: _this.game.id
                      });
                      _this.$router.push("/games/" + _this.game.id);
                  }
                  else {
      ...
      _c("div", { staticClass: "modal-content box" }, [
        _c("div", { staticClass: "columns" }, [
          _c("div", { staticClass: "column" }, [
            _c("h2", { staticClass: "title is-3" }, [
              _vm._v(
                "Join " +
                  _vm._s(_vm.game.host ? _vm.game.host.name : "") +
                  "'s game"
              )
            ]),
            _vm._v(" "),
            _c("h2", {
              ...
              domProps: { textContent: _vm._s(_vm.game.name) }
            })
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "columns" }, [
          ...
          _vm.isPrivate
            ? _c("div", { staticClass: "column" }, [
                _c("div", { staticClass: "field" }, [
                  _c("label", { staticClass: "label" }, [_vm._v("Access Key")]),
                  _vm._v(" "),
                  _c("div", { staticClass: "control" }, [
                    _c("input", {
                      directives: [
                      ...
                      staticClass: "input",
                      attrs: { type: "text" },
                      domProps: { value: _vm.formData.accessKey },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.formData, "accessKey", $event.target.value);
                        }
                      }
                    })
                  ])
  ...
  function __vue_normalize__$1(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\components\\ModalJoinGame.vue";
    }
  ...
  var ModalJoinGame = __vue_normalize__$1(
    __vue_template__$1,
  ...
  var script$2 = {
      mounted: function () {
          var _this = this;
          VueEvent.on('modal-open-error', function (data) {
              _this.modalOpen = true;
  ...
  function __vue_normalize__$2(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\components\\ModalError.vue";
    }
  ...
  var ModalError = __vue_normalize__$2(
    __vue_template__$2,
  ...
  var script$3 = Vue.extend({
      ...
      methods: {
          init: function () {
              var _this = this;
              var playerCookie = js_cookie.get(this.$store.settings.cookieName);
              ...
              var playerId = this.$store.state.player.id;
              var playerName = this.$store.state.player.name;
              ...
              if (playerId !== null) {
                  axios$1
                      ...
                      _this.isLoaded = true;
                      if (res.data.success) {
                          _this.$router.push("/games/" + gameId);
                      }
                  })
          ...
          updatePlayerCookie: function (data) {
              js_cookie.set(this.cookieName, data.gameId + "|" + data.id + "|" + data.name, {
                  expires: 7, path: '/'
              });
          },
          deletePlayerCookie: function () {
              js_cookie.remove(this.cookieName);
          }
      },
      watch: {
  ...
  function __vue_normalize__$3(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\App.vue";
    }
  ...
  var __vue_render__$4 = function() {
    ...
    return _c("div", { staticClass: "has-text-centered" }, [
      _c("p", [
        _vm._v(
          "Pit your skill of proving your existance againt others in a bitter battle for existence or death!"
        )
      ]),
      _vm._v(" "),
      _vm._m(0),
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "button is-link is-large", attrs: { to: "/games" } },
  ...
  var __vue_staticRenderFns__$4 = [
    function() {
      ...
      return _c("p", [
        _vm._v(
          "Okay maybe not the death part, but if you can't prove you exist.. maybe you are already dead?"
        ),
        _c("br"),
        _c("br")
      ])
    ...
    function() {
      ...
      var _c = _vm._self._c || _h;
      return _c("p", [
        _c("a", { staticClass: "button is-small" }, [_vm._v("How to play")])
      ])
    }
  ];
  ...
  function __vue_normalize__$4(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\pages\\Landing.vue";
    }
  ...
  var PageLanding = __vue_normalize__$4(
    __vue_template__$4,
  ...
  var script$5 = {
      ...
      methods: {
          ...
          refreshData: function () {
              var _this = this;
              axios$1.get('/api/games/list').then(function (res) { _this.games = res.data; });
          },
          refreshList: function () {
              var _this = this;
              setTimeout(function () { if (_this.updateData)
                  _this.refreshList(); }, 3000);
              this.refreshData();
          },
          openJoinGameModal: function (game) {
              VueEvent.fire('modal-open-join-game', game);
          },
          openNewGameModal: function () {
              VueEvent.fire('modal-open-new-game');
          },
          isPrivate: function (access) {
        ...
        _c(
          ...
          _vm._l(_vm.games, function(game, index) {
            return _c("tr", { key: index }, [
              ...
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(game.host.name))]),
              _vm._v(" "),
              _c("td", [
                _vm._v(_vm._s(game.players) + "/" + _vm._s(game.maxPlayers))
              ]),
              _vm._v(" "),
              _c("td", [
                _vm._v(_vm._s(_vm.isPrivate(game.access) ? "Private" : "Public"))
              ]),
              _vm._v(" "),
              _c("td", [
                _vm._v(_vm._s(game.hasStarted ? "In Progress" : "Open"))
              ]),
              _vm._v(" "),
              _c("td", [
                !game.hasStarted
  ...
  function __vue_normalize__$5(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\pages\\GameList.vue";
    }
  ...
  var PageGameList = __vue_normalize__$5(
    __vue_template__$5,
  ...
  var script$6 = Vue.extend({
      ...
      methods: {
          init: function () {
              var paramGameId = this.$route.params.gameId;
              var userGameId = this.$parent.player.gameId;
              if (userGameId === null) {
                  VueEvent.fire('modal-open-error', {
  ...
  var __vue_render__$6 = function() {
    ...
    var _c = _vm._self._c || _h;
    return _vm.isLoaded
      ? _c("div", { staticClass: "content game-active" }, [
          _c("div", { staticClass: "columns" }, [
            _c("div", { staticClass: "column" }, [
              _c("h1", {
                staticClass: "title is-3",
              ...
              _c("h2", { staticClass: "subtitle is-4" }, [
                _vm._v(_vm._s(_vm.game.host.name) + "'s game")
              ])
            ])
          ]),
          _vm._v(" "),
          ...
          _vm._v(" "),
          _c("div", { staticClass: "columns game-settings" }, [
            _c("div", { staticClass: "column" }, [
              _c("b", [_vm._v("Players:")]),
              _vm._v(
                " " +
                  ...
                  "/" +
                  _vm._s(_vm.game.settings.maxPlayers)
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "column" }, [
              _c("b", [_vm._v("Score Limit:")]),
              _vm._v(" " + _vm._s(_vm.game.settings.scoreLimit) + " points")
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "column" }, [
              _c("b", [_vm._v("Turn Limit:")]),
              _vm._v(
                " " + _vm._s(_vm.game.settings.turnTimeLimit / 1000) + " seconds"
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "column" }, [
              _c("b", [_vm._v("Access:")]),
              _vm._v(" " + _vm._s(_vm.game.settings.access))
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "columns" }, [
            _c("div", { staticClass: "column" }, [
              _vm.game.settings.access === "private"
                ? _c("pre", {
                    domProps: { textContent: _vm._s(_vm.game.settings.accessKey) }
                  })
                : _vm._e()
            ])
          ]),
          _vm._v(" "),
          _vm.game.hasStarted
            ? _c("div", { staticClass: "game-started" }, [
                _c("div", { staticClass: "columns" }, [
                  _c("div", { staticClass: "column" }, [
                    _c("h3", [_vm._v("Play Area")]),
                    _vm._v(" "),
                    _c(
                      "div",
                      { staticClass: "premises" },
                      _vm._l(_vm.game.premises, function(premise, index) {
                        return _c(
                          "div",
                          { key: index, staticClass: "premise" },
                          [
                            _c(
                              "draggable",
                              {
                                ...
                                model: {
                                  value: premise.cards,
                                  callback: function($$v) {
                                    _vm.$set(premise, "cards", $$v);
                                  },
                                  expression: "premise.cards"
                                }
                              },
                              _vm._l(premise.cards, function(card, index1) {
                                return _c(
                                  "div",
                                  { key: index1, staticClass: "card" },
                      ...
                      [
                        _c(
                          "draggable",
                          {
                            ...
                            attrs: { options: { group: "cards" } },
                            model: {
                              value: _vm.game.me.cards,
                              callback: function($$v) {
                                _vm.$set(_vm.game.me, "cards", $$v);
                              },
                              expression: "game.me.cards"
                            }
                          },
                          _vm._l(_vm.game.me.cards, function(card, index) {
                            return _c(
                              "div",
                              { key: index, staticClass: "card" },
                              [
                                _c("b", {
                                  domProps: { textContent: _vm._s(card.label) }
                                })
                              ]
                            )
                          })
            ...
            : _c("div", { staticClass: "game-waiting" }, [
                _c("div", { staticClass: "columns" }, [
                  _c("div", { staticClass: "column" }, [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.game.players, function(player, index) {
                        return _c("li", { key: index }, [
                          _c("span", {
                            domProps: { textContent: _vm._s(player.name) }
                          })
                        ])
                      })
                    )
                  ...
                  _c("div", { staticClass: "column" }, [
                    _vm.isHost
                      ? _c(
                          "a",
                          {
                            class: [
                              ...
                              { "is-loading": _vm.isStarting }
                            ],
                            attrs: { disabled: _vm.isStarting },
                            on: {
                              "~click": function($event) {
                                _vm.startGame();
                              }
                      ...
                      : _c(
                          "a",
                          {
                            staticClass: "button is-light islarge",
                            attrs: { disabled: "" }
                          },
                          [_vm._v("Waiting for host to start")]
                        )
                  ])
                ])
              ])
  ...
  function __vue_normalize__$6(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\pages\\GameActive.vue";
    }
  ...
  var PageGameActive = __vue_normalize__$6(
    __vue_template__$6,
  ...
  const __vue_template__$7 = typeof __vue_render__$7 !== 'undefined'
  ...
  function __vue_normalize__$7(
    ...
    {
      component.__file = "C:\\Users\\Ezra\\Documents\\Developer\\ergo-online\\public\\assets\\ts\\vue\\pages\\NotFound.vue";
    }
  ...
  var PageNotFound = __vue_normalize__$7(
    __vue_template__$7,
  ...
  */
  ...
  Vue.use(index_esm);
  Vue.use(VueRouter);
  Vue.prototype.$io = lib$1;
  Vue.prototype.$http = axios$1;
  Vue.prototype.$event = {
      fire: function (event, data) { this.$emit(event, data || null); },
  ...
  var store = new index_esm.Store({
      ...
      mutations: {
          setPlayerId: function (state, id) {
              state.player.id = id;
          },
          setPlayerName: function (state, name) {
              state.player.name = name;
          },
          setGameId: function (state, id) {
              state.game.id = id;
          }
      }
  });
